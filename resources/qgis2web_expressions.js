...
function exp_Rommelmarktfinalsamengevoegd_3rule0_eval_expression(context) {
    // status_kleur = 'rood'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('status_kleur')  == 'rood');
    } else {
        return (feature.get('status_kleur')  == 'rood');
    }
}
...
function exp_Rommelmarktfinalsamengevoegd_3rule1_eval_expression(context) {
    // status_kleur = 'Niet betaald'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('status_kleur')  == 'Niet betaald');
    } else {
        return (feature.get('status_kleur')  == 'Niet betaald');
    }
}
...
function exp_Rommelmarktfinalsamengevoegd_3rule2_eval_expression(context) {
    // status_kleur = 'groen'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('status_kleur')  == 'groen');
    } else {
        return (feature.get('status_kleur')  == 'groen');
    }
}